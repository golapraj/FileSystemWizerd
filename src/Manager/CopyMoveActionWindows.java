 ...
 * @author Rose
 */
public class CopyMoveActionWindows extends javax.swing.JDialog {
    ...
    public CopyMoveActionWindows(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        targerpathButton = new javax.swing.JButton();
        ...
        targetpathTextField.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        targetpathTextField.setPreferredSize(new java.awt.Dimension(200, 25));
        ...
        targerpathButton.setBackground(new java.awt.Color(0, 153, 153));
        targerpathButton.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        targerpathButton.setForeground(new java.awt.Color(255, 255, 255));
        targerpathButton.setText("Select Target Path");
        targerpathButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                targerpathButtonActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(targerpathButton, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(targetpathTextField, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(issortcutLabel))
                        .addGap(45, 45, 45)
                        .addComponent(copyProgressBar, javax.swing.GroupLayout.DEFAULT_SIZE, 19, Short.MAX_VALUE)
                        .addGap(5, 5, 5)
    ...
    private void confirmkButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmkButtonActionPerformed
        ...
        targetPath = targetpathTextField.getText();

        if (targetpathTextField.getText().length() < 3 || (allCheckBox.isSelected() == false && extensionCheckBox.isSelected() == false && containswordCheckBox.isSelected() == false && startwithCheckBox.isSelected() == false && sizeCheckBox.isSelected() == false && isshortcutCheckBox.isSelected() == false && lastmodifiedCheckBox.isSelected() == false)) {
            if (targetpathTextField.getText().length() < 3) {
                targetpathTextField.setBackground(Color.red);
                JOptionPane.showMessageDialog(rootPane, "Please Select Target Path First", "OK", JOptionPane.WARNING_MESSAGE);
                targetpathTextField.setBackground(Color.white);
            }
            if (allCheckBox.isSelected() == false && extensionCheckBox.isSelected() == false && containswordCheckBox.isSelected() == false && startwithCheckBox.isSelected() == false && sizeCheckBox.isSelected() == false && isshortcutCheckBox.isSelected() == false && lastmodifiedCheckBox.isSelected() == false) {
                JOptionPane.showMessageDialog(rootPane, "Please Select one CheckBox", "OK", JOptionPane.WARNING_MESSAGE);
            }
            ...
            try {
                if (MainWindows.parent == 1) {
                    copyProgressBar.setVisible(true);
                    copypenddingLabel.setVisible(true);
                    Copier copier = new Copier(copyProgressBar, copypenddingLabel);
                    copier.execute();
                        ...
                        public void run() {
                            while (!copier.isDone()) {
                                try {
                                    ...
                                    Logger.getLogger(CopyMoveActionWindows.class.getName()).log(Level.SEVERE, null, ex);
                                }
                            }
                            if(Copier.clk>0){
                            JOptionPane.showMessageDialog(rootPane, "Copy Successfull!", "OK", JOptionPane.INFORMATION_MESSAGE);
                            CopyMoveActionWindows.this.dispose();
                            }
                            else
                            {
                                JOptionPane.showMessageDialog(rootPane, "No File Copied!", "OK", JOptionPane.INFORMATION_MESSAGE);
                        CopyMoveActionWindows.this.dispose();
                            }
                        }
                    });
                ...
                if (MainWindows.parent == 2) {
                    copyProgressBar.setVisible(true);
                    copypenddingLabel.setVisible(true);
                    Mover copier = new Mover(copyProgressBar, copypenddingLabel);
                    copier.execute();
                    Thread t = new Thread(new Runnable() {
                        ...
                        public void run() {
                            while (!copier.isDone()) {
                              ...
                              if(Mover.clk>0){
                            JOptionPane.showMessageDialog(rootPane, "Move Successfull!", "OK", JOptionPane.INFORMATION_MESSAGE);
                            CopyMoveActionWindows.this.dispose();
                            }
                            else
                            {
                                JOptionPane.showMessageDialog(rootPane, "No File Moved!", "OK", JOptionPane.INFORMATION_MESSAGE);
                        CopyMoveActionWindows.this.dispose();
    ...
    private void targerpathButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_targerpathButtonActionPerformed
        TargetFileChooser tfc = new TargetFileChooser();
        TFile = tfc.getFiles();
        if (TFile != null) {
            targetpathTextField.setText(TFile.toPath().toString());
        }
    }//GEN-LAST:event_targerpathButtonActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CopyMoveActionWindows.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CopyMoveActionWindows dialog = new CopyMoveActionWindows(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton targerpathButton;
